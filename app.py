...
loaded_model = pickle.load(open('C:/Users/91888/projects/Resume Projects/MarketSegmentation-main/final_model.sav', 'rb'))
df = pd.read_csv("C:/Users/91888/projects/Resume Projects/MarketSegmentation-main/Clustered_Customer_Data.csv")
